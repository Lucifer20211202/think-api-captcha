...
class Captcha
{
     ...
     * @param string $uniqid 验证码key
     * @return bool 用户验证码是否正确
     */
    public function check($code, $uniqid)
    {
        // 验证码不能为空
        $secode = Cache::get($uniqid);
    ...
    public function entry()
    {
        ...
        Cache::set($uniqid, $secode, $this->expire);
